  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="C:\Users\LENOVO\Desktop\New folder (2)\photo.jpg"" width=100 height=100 alt="SUhani Bade" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Linkedin">Suhani Bade</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9975392099</h4>
		<h4 style="font-family:'typo' ">suhanibade@gmail.com</h4>
		<h4 style="font-family:'typo' ">pune</h4></div></div>
		</p>
      </div>
